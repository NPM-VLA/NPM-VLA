...
HF_DATASET_REPO = "Anlorla/sweep_to_C"
...
TASK_LABEL = "<skill>sweep<skill> Sweep red beads into letter 'C' shape inside the masked squre."
# ROS topics
# Camera topics: wide_top as main camera, two fisheye wrist cameras
CAM_MAIN = "/wide_top/image_raw/compressed"  # Wide top camera as main
CAM_WRIST_LEFT = "/fisheye_left/image_raw/compressed"
CAM_WRIST_RIGHT = "/fisheye_right/image_raw/compressed"
...
IMG_SIZE = (224,224)
# TODO:
NUM_WORKERS = 30  # Number of CPU cores to use
    ...
    try:
        with AnyReader([bag_path]) as reader:
            ...
            with lock:
                ...
                print(
                    f"    Main camera (wide_top): {main_duration:.2f} seconds ({len(cam_main_msgs)} frames)"
                )
                print(
